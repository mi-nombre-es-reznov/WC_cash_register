...
namespace WCcashregister {
	...
	public: delegate void EventDelegate2(System::Object^ sender, System::EventArgs^ e, String^ message);	// Publish an event with a text message that others can subscribe to
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &Discount::button1_Click);
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(291, 128);
			...
			this->label1->Location = System::Drawing::Point(88, 130);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(197, 16);
			this->label1->TabIndex = 2;
			this->label1->Text = L"Enter discount percentage: ";
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(353, 130);
			...
			this->label3->Size = System::Drawing::Size(185, 46);
...
#pragma endregion
	...
	public: void issueEvent2(System::Object^ sender, System::EventArgs^ e)	// This is where we publish the event to all.
	{
		this->myEvent2(this, e, this->textBox1->Text);	// Raise the event using event delegate signature
	}

	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
		if (textBox1->Text == "0")	// Give a message of whether tax was added (requires > 0%) for a tax added message.
		{
			MessageBox::Show("Discount has not been added!");
		}
		else
		{
			do
