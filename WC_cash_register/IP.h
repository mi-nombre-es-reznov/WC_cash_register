...
namespace WCcashregister {
	...
	public: delegate void EventDelegate3(System::Object^ sender, System::EventArgs^ e, String^ message);	// Publish an event with a text message that others can subscribe to
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(424, 135);
			...
			this->label1->Location = System::Drawing::Point(129, 135);
			this->label1->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(287, 20);
			this->label1->TabIndex = 2;
			this->label1->Text = L"Enter IP Address of host server: ";
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(493, 257);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 30, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(203, 44);
			this->label3->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(279, 58);
			...
			this->ClientSize = System::Drawing::Size(655, 318);
...
#pragma endregion
	...
	{
		this->myEvent3(this, e, this->textBox1->Text);	// Raise the event using event delegate signature
	}

	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
		if (textBox1->Text == "0")	// Give a message of whether tax was added (requires > 0%) for a tax added message.
		{
			MessageBox::Show("IP Address has not been entered!");
		}
		else
		{
			this->issueEvent3(sender, e);
			MessageBox::Show("IP address has been entered.");
		}
	}
	};
}
